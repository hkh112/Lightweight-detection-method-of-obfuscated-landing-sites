...
for(i=1; i<=file_num; i++){
	...
	var filename = "ob_type_" + i;
	
	//js_file = fs.readFileSync('/home/lab15/esprima_fun/dataset/webpages/' + filename);
	//js_file = fs.readFileSync('/home/lab15/esprima_fun/dataset/ob_malicious_500files/' + filename);
	js_file = fs.readFileSync('/home/lab15/esprima_fun/dataset/ob_type_samples/' + filename);
	...
	fs.writeFileSync('/home/lab15/esprima_fun/dataset/ob_type_ASTs/ob_type_' + (++write_file_num) + '.ast', ast_Structure);
