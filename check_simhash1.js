...
ast1 = fs.readFileSync('/home/lab15/esprima_fun/dataset/ob_malicious_500files_ministructure/ob_mal_1.ast');
...
for(i=1;i<=100;i++){
	...
	//if(similiarity > 0.9){
		...
		fs.writeFileSync('/home/lab15/esprima_fun/dataset/simhash_result/simhash_result1_mini_ob_benign', 'ob_benign_' + i + '.ast , ' + similiarity + '\n', {flag: 'a'});
