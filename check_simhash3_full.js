...
ast1 = fs.readFileSync('/home/lab15/esprima_fun/dataset/representative_structure/ob_mal_full251.ast');
...
for(i=1;i<=1000;i++){
	...
	//if(similiarity > 0.9){
		...
		fs.writeFileSync('/home/lab15/esprima_fun/dataset/simhash_result/simhash_result3_full', similiarity + '\n', {flag: 'a'});
