...
ast1 = fs.readFileSync('/home/lab15/esprima_fun/dataset/representative_structure/ob_mal_full376.ast');
...
for(i=1;i<=500;i++){
	...
	//if(similiarity > 0.9){
		...
		fs.writeFileSync('/home/lab15/esprima_fun/dataset/simhash_result/simhash_result4_full', similiarity + '\n', {flag: 'a'});
